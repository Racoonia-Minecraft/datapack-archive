...
execute as @e[type=minecraft:pig,tag=racooniachairs,tag=!global.ignore,tag=!global.ignore.kill] at @s unless block ~ ~1 ~ #minecraft:stairs positioned ~ ~.5 ~ run function _racooniachairs:kill
