#declare tag packages.package_unlocked

tag @s remove packages.package_unlocked
setblock ~ ~ ~ minecraft:air
playsound minecraft:block.grass.break master @a[distance=..10,tag=!global.ignore,tag=!global.ignore.gui] ~ ~ ~ 1 0
