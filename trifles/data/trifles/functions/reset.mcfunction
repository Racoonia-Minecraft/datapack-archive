...
scoreboard players reset @a trifles.hasPocketcat
scoreboard players reset @a trifles.megastewCooldown
scoreboard players reset @a trifles.pocketcatCooldown
